...
public class RegressionTests  {
	private final AmalgamSolver solver = new AmalgamSolver();
	...
	// fin = (all e: R | one ((e . f) - (e . f))) && 
        ...
        AmalgamCore solver = new AmalgamCore();
	...
	public final void testMarceloSimplified_041912() {
		...
		final AmalgamCore solver = new AmalgamCore();
...
//		System.out.println(sol);
	...
	public final void testLingeling_Jasmin_092611() {
		for(int j = 0; j < 1000; j++) {
			...
			final AmalgamCore solver = new AmalgamCore(options);
	...
	public final void testFelix_05072008() { 
		...
		AmalgamSolver solver = new AmalgamSolver();
	...
	private static boolean isMinimal(AmalgamCore solver, Bounds bounds, Set<Formula> core) {
