...
public class A4Preferences {
   ...
   public static Pref<?>[] nonUserPrefs = new Pref<?>[] { 
       ...
       // MODIFY model enumeration strategy
       public static StringChoicePref ModelStrategy = new StringChoicePref("Model Strategy", 
               Arrays.asList("Alloy (arbitrary models)",
                       "Aluminum (minimal models)",
                       "show me only maximal models"),
                       //"show me high coverage models"), 
               "");
